...
page_2025 = st.Page("2025_SEASON.py", title="2025", icon=":material/stars:")
...
with st.sidebar:
	...
	st.page_link(page_2025, label=page_2025.title, icon=page_2025.icon)
	...
	st.page_link(page="https://fantasy.premierleague.com/leagues/1059421/standings/c", label="FANTASY LEAGUE", icon=":material/table_rows_narrow:")
