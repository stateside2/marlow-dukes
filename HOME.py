...
# ---- BOARDROOM DF BUILD
df_broom = pd.read_excel(excel_file_season, skiprows=7, nrows=7, sheet_name='Board Room', usecols=[12,13]).fillna(0)
...
if menu_selection == "Board Room":
	st.dataframe(df_broom, width=None, height=360, use_container_width=True, hide_index=True, column_config={"POSITION": " ","Unnamed: 12": "PLAYER", "Unnamed: 13": "VISITS"})
