...
df_broom = pd.read_excel(excel_file, skiprows=7, nrows=18, sheet_name='Board Room', usecols=[12,13])
...
if menu_selection == "Board Room":
	st.dataframe(df_broom, width=None, height=675, use_container_width=True, hide_index=True, column_config={"Unnamed: 12": "PLAYER", "Unnamed: 13": "VISITS"})
