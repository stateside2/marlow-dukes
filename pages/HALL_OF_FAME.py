...
if hof_selection == "All-time Goals": #--- 1.4
	...
	st.dataframe(df_at_goals_tab, width=None, height=2100, use_container_width=True, hide_index=True, column_order=["PLAYER","ALL-TIME GOALS"], column_config={"ALL-TIME GOALS": "GOALS"})
...
if hof_selection == "All-time MOTM Votes": #--- 1.4
	...
	st.dataframe(df_at_MOTM_tab, width=None, height=2050, use_container_width=True, hide_index=True, column_order=["PLAYER","ALL-TIME VOTES"], column_config={"ALL-TIME VOTES": "VOTES"})
